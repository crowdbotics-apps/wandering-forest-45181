"""
Django settings for wandering_forest_45181 project.
...
ROOT_URLCONF = 'wandering_forest_45181.urls'
...
WSGI_APPLICATION = 'wandering_forest_45181.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wandering_forest_45181 API",
    "DESCRIPTION": "API documentation for wandering_forest_45181 App",
    "VERSION": "v1",
}
